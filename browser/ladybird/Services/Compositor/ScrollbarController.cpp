...
bool ScrollbarController::paint(Gfx::PaintingSurface& surface, Compositing::DisplayListPlayerTrinity& display_list_player, Compositing::ScrollStateSnapshot const& scroll_state_snapshot) const
{
