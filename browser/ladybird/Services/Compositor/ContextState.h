...
class DisplayListPlayerTrinity;
...
public:
    ...
    Optional<BackingStoreManager::Publication> resize_backing_stores_if_needed();
    ...
    Optional<PreparedFrame> prepare_frame(Compositing::DisplayListPlayerTrinity&, PendingFrame, CompositedContextResolver const*);
    void did_submit_prepared_frame(Gfx::IntRect);
    bool present_synchronously(Compositing::DisplayListPlayerTrinity&, CompositedContextResolver const*);
    bool can_paint_screenshot(Gfx::ShareableBitmap&) const;
    void paint_screenshot(Compositing::DisplayListPlayerTrinity&, Gfx::ShareableBitmap&, CompositedContextResolver const*);
...
private:
    ...
    void paint_current_display_list(Compositing::DisplayListPlayerTrinity&, Gfx::PaintingSurface&, CompositedContextResolver const*, Optional<Gfx::IntRect> damage_rect = {}, PaintUIOverlay = PaintUIOverlay::Yes, bool apply_raster_transform = true);
