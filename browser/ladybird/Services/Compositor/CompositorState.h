...
public:
    static NonnullRefPtr<CompositorState> create(bool async_scrolling_enabled);
    ~CompositorState();
...
private:
    explicit CompositorState(bool async_scrolling_enabled);
...
private:
    ...
    OwnPtr<Compositing::DisplayListPlayerTrinity> m_display_list_player;
