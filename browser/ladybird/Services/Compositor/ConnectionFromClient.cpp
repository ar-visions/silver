...
ConnectionFromClient::ConnectionFromClient(NonnullOwnPtr<IPC::Transport> transport, bool async_scrolling_enabled)
    : IPC::ConnectionFromClient<CompositorControlClientEndpoint, CompositorControlServerEndpoint>(*this, move(transport), 1)
    , m_compositor_state(CompositorState::create(async_scrolling_enabled))
{
