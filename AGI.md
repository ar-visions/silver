...
The product for this is **Orbiter** — it lets you run web4 apps with an ability to edit the source if it’s available.  We define apps as either console, graphical with desktop-spatial used when there are IR cameras <sup><sub>[1]</sub></sup>

<sup><sub>[1]: Logitech Brio supported on Linux with it's low emission pulse-IR</sub></sup>
