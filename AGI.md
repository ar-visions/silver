...
The product for this is **Orbiter** — it lets you run web4 apps with an ability to edit the source if it’s available.  We define apps as either console, graphical with desktop-spatial used when there are IR cameras [1].  As such, source editing will be rendered in both console, and graphical modes.
