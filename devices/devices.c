...
// the app hosting channel, shared by every process silver-host spawns
#if defined(_WIN32)
#define HOST_API __attribute__((dllexport))
// windows: no hosting; each call reports "nothing there"
