...
int Test_set_value_test (int value)return Test_cl->get_value_test();}
    
int Test_get_value (Test self){
            return self->value_intern;
        }
        
int Test_set_value (Test self, int value)return self->get_value(self);}
...
static void module_constructor(void) __attribute__(constructor) {
	...
	Test_cl->arg_test = Base_arg_test;
	...
	Test_cl->member_types = (char *)malloc(28);
	...
	Test_cl->member_types[11] = 1;
	Test_cl->member_types[12] = 0;
	Test_cl->member_types[13] = 0;
	Test_cl->member_types[14] = 1;
	Test_cl->member_types[15] = 2;
	Test_cl->member_types[16] = 2;
	Test_cl->member_types[17] = 2;
	...
	Test_cl->member_types[25] = 0;
	Test_cl->member_types[26] = 1;
	Test_cl->member_types[27] = 1;
	Test_cl->member_names = (const char **)malloc(28 * sizeof(const char *));
	...
	Test_cl->member_names[7] = "arg_test";
	Test_cl->member_names[8] = "dealloc";
	Test_cl->member_names[9] = "init_object";
	Test_cl->member_names[10] = "new_object";
	Test_cl->member_names[11] = "free_object";
	Test_cl->member_names[12] = "test_me";
	Test_cl->member_names[13] = "test_me";
	Test_cl->member_names[14] = "super_only";
	Test_cl->member_names[15] = "Test";
	Test_cl->member_names[16] = "i";
	Test_cl->member_names[17] = "s";
	Test_cl->member_names[18] = "test1";
	Test_cl->member_names[19] = "test1";
	Test_cl->member_names[20] = "value_intern";
	Test_cl->member_names[21] = "value_intern";
	Test_cl->member_names[22] = "value_test";
	Test_cl->member_names[23] = "value_test";
	Test_cl->member_names[24] = "value";
	Test_cl->member_names[25] = "value";
	Test_cl->member_names[26] = "method";
	Test_cl->member_names[27] = "Main";
	Test_cl->member_count = 28;
}
